...
public class APConstant {
    ...
    public final static String ROUTE_SENSOR = "sensor";
    public final static String ROUTE_MODE = "mode";
    public final static String ROUTE_ORIGIN = "origin";
    public final static String ROUTE_DESTENATION = "destination";
